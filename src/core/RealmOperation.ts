...
interface RealmOperationOutHkt<I extends Product, O extends Product, C>
  extends Hkt {
  [Hkt.output]: RealmOperationOut<I, O, Hkt.Input<this>, C>;
}

type RealmGenericOperationOut<
  I extends Product,
  O extends Hkt<I, Product>,
  Arg,
  C,
> = [I] extends [Product]
  ? [O] extends [Hkt<I, Product>]
    ? Arg extends Element<Assert<I, infer J>>
      ? RealmElement<Hkt.Output<O, J>, C>
    : Arg extends GenericOperation<infer T, Assert<Hkt<infer T, I>, infer U>>
    ...
    : Arg extends Component<infer A, infer T>
      ? Component<A, RealmGenericOperationOut<I, O, T, C>>
...
export const RealmOperation = {
  create: <I extends Product, O extends Product, C>(
    realm: Realm<C>,
    operation: Operation<I, O>,
  ): RealmOperation<I, O, C> => {
...
export type RealmGenericOperation<
  I extends Product,
  O extends Hkt<I, Product>,
  C,
> =
