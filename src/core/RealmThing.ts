...
export type RealmThing<T extends Thing, C> = T extends Element<infer T>
  ? RealmElement<T, C>
  : T extends GenericComponent<infer T, infer I, infer O>
    ? RealmGenericComponent<T, I, O, C>
  : T extends Component<infer I, infer O> ? RealmComponent<I, O, C>
  : T extends GenericOperation<infer I, infer O>
    ? RealmGenericOperation<I, O, C>
