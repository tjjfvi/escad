...
export const Product = {
  isProduct,
  getProductType: Timer.create().timeFn(
    <P extends Product>(product: P): ProductType<P> => {
...
function isProduct<P extends Product>(
  arg: any,
...
export const ProductType = {
  ...
  fromProductTypeish: <T extends Product>(
    productTypeish: ProductTypeish<T>,
  ): ProductType<T> =>
    ProductType.isProductType(productTypeish)
      ? productTypeish
      : productTypeish?.productType,
};

export type ProductTypeish<T extends Product> = ProductType<T> | {
