...
import { rotate, rotateX, rotateY, rotateZ, rX, rY, rZ } from "./rotate.ts";
import { scale, scaleX, scaleY, scaleZ, sX, sY, sZ } from "./scale.ts";
...
import { cyl, cylinder } from "./cylinder.ts";
