  ...
  (axis: "x" | "y" | "z", center: number = 0) => {
    ...
    return mapOperation(
      ...
      (leaf: ConvertibleTo<Mesh>) =>
        FlipFaces.create(
          Transform.create(TupleProduct.create([matrix, leaf] as const)),
        ),
      { showOutput: false },
    );
  },
...
export const reflectX = Component.create(
  "reflectX",
  (center: number = 0) => reflect("x", center),
  { showOutput: false },
);
export const reflectY = Component.create(
  "reflectY",
  (center: number = 0) => reflect("y", center),
  { showOutput: false },
);
export const reflectZ = Component.create(
  "reflectZ",
  (center: number = 0) => reflect("z", center),
  { showOutput: false },
);
